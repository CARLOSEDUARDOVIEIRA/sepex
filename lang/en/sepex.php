...
$string['integrantes_help'] = 'Digite o nome dos autor(es)/apresentador(es) do projeto, o nome será autopreenchido. Selecione o nome completo e em seguida pressione [Enter] do seu teclado e aguarde aparecer o nome completo do aluno na parte superior destacado em azul.';
$string['curso'] = 'Curso';
...
$string['categoria_help'] = 'Informe a Categoria do projeto';
