...
$string['modulenameplural'] = 'Sepex';
$string['modulename_help'] = 'O plugin SEPEX foi desenvolvido para gerênciar os processos deste evento que ocorre no Centro Universitário Católico de Vitória.';
$string['sepex:addinstance'] = 'Adicionar uma nova Instância Sepex';
$string['sepex:submit'] = 'Submit sepex';
$string['sepex:view'] = 'View Sepex';
$string['sepexfieldset'] = 'Custom example fieldset';
...
$string['integrantes_help'] = 'Digite a matricula dos integrantes do projeto e use <b>;</b> "ponto e virgula" para separar as matriculas dos proximos alunos. É imprescindível que as matriculas estejam certas e digitadas neste formato de exemplo: 6914001025;6914001026;6914001027. Não use espaços!';
$string['curso'] = 'Curso';
$string['curso_help'] = 'Informe o curso em que estão matriculados os integrantes do projeto';
$string['periodo'] = 'Período';
$string['periodo_help'] = 'Informe o período dos integrantes do projeto';
$string['turno'] = 'Turno';
$string['turno_help'] = 'Informe o turno em que se encontram matriculados os integrantes do projeto';
$string['categoria'] = 'Categoria';
$string['categoria_help'] = 'Informe a categoria a qual deseja participar com seu projeto';
$string['titulo'] = 'Título';
$string['titulo_help'] = 'Informe o título do seu projeto utilizando apenas a letra inicial de cada palavra em maiusculo. Exemplo: Meu Projeto Sepex UCV';
$string['email'] = 'Email';
$string['email_help'] = 'Informe o email de um dos integrantes do seu projeto. Exemplo "meuemail@provedor.com"';
$string['orientador'] = 'Selecione o professor orientador do projeto:';
$string['orientador_help'] = 'Selecione o professor orientador';
...
$string['turnovazio'] = 'Campo turno vazio clique em (?) em caso de dúvidas';
$string['categoriavazio'] = 'Campo categoria vazio clique em (?) em caso de dúvidas';
$string['emailvazio'] = 'Campo email vazio ou email inválido! Clique em (?) em caso de dúvidas';
$string['titulovazio'] = 'Campo título vazio clique em (?) em caso de dúvidas';
$string['integrantevazio'] = 'Campo apresentador vazio clique em (?) em caso de dúvidas';
$string['orientadorvazio'] = 'Campo professor orientador vazio clique em (?) em caso de dúvidas';
$string['resumovazio'] = 'Campo resumo vazio clique em (?) em caso de dúvidas';
...
$string['resumo_help'] = 'O resumo a ser postado na sepex deve possuir no máximo 250 palavras. A direita do editor existe um contador dinâmico informando a quantidade de palavras digitadas. Serão reprovados resumos que excendam este limite!';
$string['tags'] = 'Palavras Chave (use de 3 à 5)';
$string['tags_help'] = 'Insira no máximo 5 palavras chave do seu resumo separadas por . "ponto final" exemplo: palavra1. palavra2. palavra3. palavra4. palavra5';
$string['add'] = 'Adicionar';
$string['orientador2'] = '';
$string['autor'] = 'Autor(es)';
$string['envio'] = 'ENVIO';
$string['titulo_projeto'] = 'TÍTULO';
$string['editar'] = 'EDITAR';
$string['apagar'] = 'EXCLUIR';
$string['cod_projeto'] = 'CÓDIGO';
$string['categoria_projeto'] = 'CATEGORIA';
...
$string['area_help'] = 'Informe a àrea dos cursos que deseja filtrar.';
...
$string['voltar_menu'] = 'Voltar ao menu principal';
...
$string['organizacaosepex'] = 'Menu principal de organização do evento SEPEX';
$string['avaliar_resumo'] = 'Avaliar resumo do projeto';
$string['gerenciar_locais'] = 'Gerenciar locais de apresentação SEPEX';
$string['add_locais'] = '<b> Adicionar local de apresentação </b>';
$string['placeholderlocais'] = 'Nome do local de apresentação';
$string['campo_requerido'] = 'Campo requerido!';
...
$string['resumo_revista'] = 'Gerar documento com resumos padrão revista';
...
$string['qualidade_resumo_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['objetivos_resumo'] = 'Objetivos claros';
$string['objetivos_resumo_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['metodologia_resumo'] = 'Descrição clara da metodologia';
$string['metodologia_resumo_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['resultados_resumo'] = 'Qualidade dos resultados';
$string['resultados_resumo_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
...
$string['tempo_apresentacao_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['conhecimento_apresentacao'] = 'Demonstração de segurança e conhecimento';
$string['conhecimento_apresentacao_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
...
$string['interdisc_apresentacao_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['valorizacao_apresentacao'] = 'Valorização dos conhecimentos teóricos frente ao desenvolvimento do trabalho';
$string['valorizacao_apresentacao_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
...
$string['ortografia_help'] = 'Qualidade esperada de acordo com o padrão de ortografia e redação acadêmico-científica';
$string['relacao_tema'] = 'Relação com o tema proposto';
$string['relacao_tema_help'] = 'Relação da escrita com o tema proposto';
$string['introducao'] = 'Introdução';
$string['introducao_help'] = 'Qualidade da introdução';
$string['metodos'] = 'Métodos';
$string['metodos_help'] = 'Qualidade dos Métodos';
$string['resultados_discussao'] = 'Resultados e Discussão';
$string['resultados_discussao_help'] = 'Qualidade dos resultados e discussão';
$string['consideracoes_finais'] = 'Considerações finais';
$string['consideracoes_finais_help'] = 'Qualidade das considerações finais';
$string['referenciais_utilizados'] = 'Referenciais utilizados';
$string['referenciais_utilizados_help'] = 'Qualidade das referências utilizadas';
//--Campos de video
...
$string['originalidade_video_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
...
$string['adequacao_foto_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['qualidade_foto'] = 'Qualidade da fotografia';
$string['qualidade_foto_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
$string['emocao_foto'] = 'Emoção captada pela foto';
$string['emocao_foto_help'] = 'Use . "Ponto" para separar as casas decimais de sua nota';
...
$string['em_avaliacao'] = 'Em avaliação';
...
//Relatorios
$string['header_relatorios'] = 'Gerar relatório';
$string['solicita_mesa'] = 'Mesa';
$string['solicita_mesa_help'] = 'Lista todos os projetos que necessitam de mesa para apresentação';
$string['projeto_solicita_mesa'] = 'Este projeto solicitou mesa para apresentação.';
$string['projeto_nao_solicita_mesa'] = 'Este projeto não solicitou mesa para apresentação.';
$string['aluno_presente'] = 'Aluno presente';
$string['projeto_nota'] = 'Projeto Com/Sem nota';
$string['exibir_relatorios'] = 'Exibir Relatórios dos Projetos Cadastrados';
$string['imprimir'] = 'IMPRIMIR';
$string['situacao'] = 'RESUMO';
$string['situacao_help'] = 'Filtrar os projetos de acordo com a situação dos resumos entre Aprovados, Não Aprovados e Não Avaliados';
